...
class MyFreenectDevice : public Freenect::FreenectDevice {
  public:
	MyFreenectDevice(freenect_context *_ctx, int _index)
		: Freenect::FreenectDevice(_ctx, _index), m_buffer_depth((640*480*sizeof(uint16_t))),m_buffer_rgb((640*480*3) ), m_gamma(2048), m_new_rgb_frame(false), m_new_depth_frame(false),
...
class KinectHandler
{
    public:
        ...
        void startDevice();
        void stopDevice();
        void captureImageAndDepth();
        void getImage();
        void getDepth();

        float rawDepthToMeters(uint16_t rawDepth);
